...
export default function RideFilter() {
  ...
  return <Container>
    <ParameterContainer>
      ...
      <select onChange={event => dispatch({field: "type", type: "set", payload: event.target.value})}
    ...
    <ParameterContainer>
      <LabelContainer>
        <input type="checkbox"
               id="disableDirection"
               onChange={(event) => dispatch({type: "disable", field: "direction", payload: !event.target.checked})}
        />
        <label htmlFor="disableDirection">Direction</label>
      </LabelContainer>
      <select onChange={event => dispatch({field: "direction", type: "set", payload: event.target.value})}
    ...
    <ParameterContainer>
      <LabelContainer>
        <input type="checkbox"
               ...
               onChange={(event) => dispatch({type: "disable", field: "destination", payload: !event.target.checked})}
        />
        <label htmlFor="disableDestination">Destination</label>
      </LabelContainer>
      <LocationsDropdown onChange={event => dispatch({field: "destination", type: "set", payload: event.target.value})}
    ...
    <ParameterContainer>
      <input type="checkbox"
             id="disableStartDate"
             onChange={(event) => dispatch({type: "disable", field: "startDate", payload: !event.target.checked})}
      />
      <input type="date" disabled={state.startDate.disabled}/><input type="date" disabled={state.endDate.disabled}/>
      <input type="checkbox"
             id="disableEndDate"
             onChange={(event) => dispatch({type: "disable", field: "endDate", payload: !event.target.checked})}
      />
    </ParameterContainer>
  </Container>
}
