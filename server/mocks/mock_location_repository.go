...
// Source: github.com/aliparlakci/country-roads/repositories (interfaces: LocationFinder,LocationInserter,LocationRepository)
...
func (m *MockLocationRepository) Exists(arg0 context.Context, arg1 interface{}) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockLocationRepositoryMockRecorder) Exists(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Exists", reflect.TypeOf((*MockLocationRepository)(nil).Exists), arg0, arg1)
}
